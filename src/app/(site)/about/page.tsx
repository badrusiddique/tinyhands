...
export const metadata: Metadata = {
  title: 'About LittleHumans - A Keyboard Toy for Ayaan',
  description: 'The story behind LittleHumans - built by a WFH dad for his keyboard-smashing toddler Ayaan.',
}
    ...
    <div className="min-h-screen">
      ...
      <section className="bg-rainbow py-20 text-center px-4 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h1 className="text-5xl sm:text-6xl font-extrabold text-white drop-shadow-md mb-4">Meet LittleHumans 👶</h1>
      ...
      <section className="bg-white py-16 px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
            ...
            <p>
              LittleHumans was born out of that frustration, and a lot of love. It turns every
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            <FAQItem
              ...
              answer="Yes! LittleHumans intercepts all keyboard input. Dangerous shortcuts (Ctrl+W, Alt+F4, etc.) are blocked. Your toddler can't close tabs, send emails, or navigate away. The screen stays on the smash canvas until you close it."
            />
            <FAQItem
